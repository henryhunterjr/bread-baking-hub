        ...
        <div className="relative">
          ...
          <div className="relative perspective-1000">
            ...
            <div className="relative mb-16">
              ...
              {/* Books on top shelf */}
              <div className="flex justify-center items-end gap-2 pb-4 relative z-10">
                {topShelf.map((book, index) => (
                  <div
                    key={book.id}
                    className="relative group cursor-pointer transition-all duration-500 hover:scale-110 hover:-translate-y-4 hover:rotate-0 hover:z-20"
                    style={{
                  ...
                  >
                    <img
                      src={book.cover}
                      alt={book.title}
                      className="h-40 w-auto object-cover rounded shadow-lg border border-gray-300"
                      style={{
