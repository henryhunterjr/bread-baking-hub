            ...
            <NavigationMenu>
              <NavigationMenuList className="gap-0">
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent className="left-0 bg-popover border shadow-lg rounded-md">
              ...
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem>
                    ...
                    <NavigationMenuContent className="right-0 bg-popover border shadow-lg rounded-md">
