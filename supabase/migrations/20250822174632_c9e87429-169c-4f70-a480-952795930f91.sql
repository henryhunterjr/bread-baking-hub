-- Enhance search functions with trigram support for better partial matching

-- Update search_recipes function to use trigram similarity
...
-- Update search_blog_posts function to use trigram similarity  
