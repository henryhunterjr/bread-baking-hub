-- Security hardening for newsletter_subscribers and function/extension hygiene
begin;

-- 1) Ensure citext extension exists and is up to date
create extension if not exists citext with schema public;
alter extension if exists citext update;
...
-- 6) Update other common extensions flagged in audits (idempotent)
