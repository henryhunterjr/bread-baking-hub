...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Priority: social_image_url → inline_image_url → hero_image_url (data) → hero_image_url (top-level) → image_url → default
    ...
    const rawImageUrl = socialImageUrl || inlineImageUrl || heroImageUrl || recipe.hero_image_url || recipe.image_url || 'https://bakinggreatbread.com/lovable-uploads/f2a6c7d6-5a78-4068-94bd-1810dd3ebd96.png';
